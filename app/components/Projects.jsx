   ...
   id='work' className='w-full py-10 scroll-mt-[120px]'>
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-8 items-center justify-items-center'>
        ...
        <motion.div 
            ...
            <div onClick={() => setShowOverlay1(prev => !prev)}><Image src={spacez} alt='spacez' className='w-xl'/></div>
            {/* glass content */}
            <div className={`absolute inset-0  bg-white/10 backdrop-blur-md text-center opacity-0 group-hover:opacity-100 ${showOverlay1? 'opacity-100' : 'opacity-0 pointer-events-none'} transition duration-300 ease-in-out z-10 overflow-y-auto sm:overflow-y-scroll px-4 sm:px-2 py-6`}onClick={() => setShowOverlay1(false)}>
        ...
        <motion.div 
            ...
            className='relative w-fit group overflow-hidden rounded-2xl'>
            <div onClick={() => setShowOverlay3(prev => !prev)}><Image src={real} alt='realestate' className='w-xl'/></div>
            {/* glass content */}
            <div className={`absolute inset-0  bg-[#814b95]/10 backdrop-blur-md text-center opacity-0 group-hover:opacity-100 ${showOverlay3? 'opacity-100' : 'opacity-0 pointer-events-none'} transition duration-300 ease-in-out z-10 overflow-y-auto sm:overflow-y-scroll px-4 sm:px-2 py-6`} onClick={() => setShowOverlay3(false)}>
              <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        className='relative w-fit group overflow-hidden rounded-2xl'>
            <div onClick={() => setShowOverlay4(prev => !prev)}><Image src={chat} alt='chatbot' className='w-xl'/></div> 
            {/* glass content */}
            <div className={`absolute inset-0  bg-[#37415c]/10 backdrop-blur-md text-center opacity-0 group-hover:opacity-100 ${showOverlay4? 'opacity-100' : 'opacity-0 pointer-events-none'} transition duration-300 ease-in-out z-10 overflow-y-auto sm:overflow-y-scroll px-4 sm:px-2 py-6`} onClick={() => setShowOverlay4(false)}>
              <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <motion.div 
            ...
            className='relative w-fit group overflow-hidden rounded-2xl'>
            <div onClick={() => setShowOverlay5(prev => !prev)}><Image src={exploreo} alt='exploreo' className='w-xl'/> </div>
            {/* glass content */}
            <div className={`absolute inset-0  bg-[#2c98a0]/10 backdrop-blur-md text-center opacity-0 group-hover:opacity-100 ${showOverlay5? 'opacity-100' : 'opacity-0 pointer-events-none'} transition duration-300 ease-in-out z-10 overflow-y-auto sm:overflow-y-scroll px-4 sm:px-2 py-6`} onClick={() => setShowOverlay5(false)}>
              <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <motion.div 
            ...
            className='relative w-fit group overflow-hidden rounded-2xl'>
            <div onClick={() => setShowOverlay6(prev => !prev)}><Image src={luxform} alt='luxform' className='w-xl'/></div>
            {/* glass content */}
            <div className={`absolute inset-0  bg-[#702c2b]/10 backdrop-blur-md text-center opacity-0 group-hover:opacity-100 ${showOverlay6? 'opacity-100' : 'opacity-0 pointer-events-none'} transition duration-300 ease-in-out z-10 overflow-y-auto sm:overflow-y-scroll px-4 sm:px-2 py-6`} onClick={() => setShowOverlay6(false)}>
              <div className='flex flex-col gap-2 justify-center items-center'>
